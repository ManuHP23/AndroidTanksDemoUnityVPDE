...
public class TankMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        m_MovementInputValue = CrossPlatformInputManager.GetAxis(m_MovementAxisName); //almacena valor de movimiento vertical
        m_TurnInputValue = CrossPlatformInputManager.GetAxis(m_TurnAxisName); //almacena valor de movimiento horizontal
